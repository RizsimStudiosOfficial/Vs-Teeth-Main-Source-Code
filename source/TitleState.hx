...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var city:FlxSprite = new FlxSprite(titleJSON.buildingsx, titleJSON.buildingsy).loadGraphic(Paths.image('menu/city'));
		city.antialiasing = ClientPrefs.globalAntialiasing;
		add(city);
		
		var ground:FlxSprite = new FlxSprite(titleJSON.groundx, titleJSON.groundy).loadGraphic(Paths.image('menu/ground'));
