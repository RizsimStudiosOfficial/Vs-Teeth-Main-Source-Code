...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Well your gonna die', 0.2], //From 0% to 19%
		['What was that lol', 0.4], //From 20% to 39%
		...
		['Very Noice!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
